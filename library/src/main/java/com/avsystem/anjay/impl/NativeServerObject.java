...
import com.avsystem.anjay.AnjayServerObject.Instance;
...
public final class NativeServerObject {
    ...
    private native int anjayServerObjectAddInstance(Instance instance, int preferredIid);

    private native void anjayServerObjectPurge();

    private native int anjayServerObjectPersist(OutputStream output_stream);

    private native int anjayServerObjectRestore(InputStream input_stream);
