...
class BootstrapOneResourceAtATimeTest(BootstrapTest.Test):
    def runTest(self):
        ...
        # perform some operation to make sure that the client received response
        # to Register message before closing it
...
class MultipleBootstrapSecurityInstancesNotAllowed(BootstrapTest.Test):
    ...
    def runTest(self):
        ...
        # Bootstrap Server MUST NOT be allowed to create second Bootstrap
        # Security Instance
...
class BootstrapFinishWithTimeoutTwice(BootstrapTest.Test):
    ...
    def runTest(self):
        ...
        # send Bootstrap Finish once again to ensure client doesn't act
        # abnormally
        self.perform_bootstrap_finish()
...
class ClientInitiatedBootstrapOnly(BootstrapTest.Test):
    ...
    def runTest(self):
        ...
        # Respond to it with 4.00 Bad Request to simulate some kind of client
        # account expiration on server side.
        ...
        # To which we respond with 4.03 Forbidden, finishing off the
        # communication.
        self.serv.send(Lwm2mErrorResponse.matching(
...
class DtlsBootstrap:
    class Test(BootstrapTest.Test):
        ...
        # example ciphersuites, source:
        # https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml
        SUPPORTED_CIPHER = 0xC0A8  # TLS_PSK_WITH_AES_128_CCM_8, recommended by RFC8252
        # TLS_PSK_WITH_AES_256_CCM_8, supported by mbed TLS and OpenSSL, but
        # not by pymbedtls
...
class NoBootstrapAfterCompleteFail(BootstrapTest.Test):
    ...
    def runTest(self):
        ...
        # check that another registration failure will cause a bootstrap
        # attempt
        with self.serv.fake_close():
